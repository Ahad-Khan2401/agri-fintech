...
export type Database = {
  public: {
    Tables: {
      ...
      livestock: { Row: { id: string; farmer_id: string; title: string; breed: string|null; age_months: number; weight_kg: number; location: any; location_city: string|null; area: string|null; cost_price: number; total_shares: number; price_per_share: number; farmer_shares: number; shares_available: number; status: string; insurance_enabled: boolean; created_at: string } }
      ...
      kyc_documents: { Row: { id: string; user_id: string; type: string|null; document_type: string|null; file_url: string; status: string; verified_by: string|null; notes: string|null; admin_notes: string|null; created_at: string } }
    }
  }
}
